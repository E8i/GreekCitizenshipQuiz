...
public class History1 extends AppCompatActivity {
    ...
    private answerclass[] questionBank= new answerclass[]
            {
               ...
               new answerclass(R.string.question_2,R.string.question_2A,R.string.question_2B,R.string.question_2C,R.string.question_2D,R.string.answer_2),
                    ...
                    new answerclass(R.string.question_20,R.string.question_20A,R.string.question_20B,R.string.question_20C,R.string.question_20D,R.string.answer_19)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aswerBTN1=findViewById(R.id.aswerBTN1);
        aswerBTN1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(History1.this,History_answer1.class);
